...
class DeepSGUS_CNN(object):
    ...
    def __init__(self, model_filepath='C:/Users/shrey/Downloads/Assessment-of-pSS-from-SGUS-images-master/Assessment-of-pSS-from-SGUS-images-master/2 Deep Learning - SG segmentation/FCN-DenseNet inference/frozen_graph.pb', inputSize = 224):
    ...
    def loadImage(self, img):
        ...
        if type(img) == str :
            ...
            try:
                ...
                print("Image " + img + " cannot be loaded, please check.")
